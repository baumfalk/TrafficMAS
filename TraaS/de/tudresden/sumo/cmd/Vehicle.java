...
public class Vehicle {
	 ...
	 */
	public static SumoCommand setSpeedMode(String vehID, int speedMode) {
		return new SumoCommand(Constants.CMD_SET_VEHICLE_VARIABLE, Constants.VAR_SPEED_MODE, vehID, speedMode);
	}
