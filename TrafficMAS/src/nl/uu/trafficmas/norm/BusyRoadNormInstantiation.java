...
public class BusyRoadNormInstantiation extends NormInstantiation {

	public BusyRoadNormInstantiation(NormScheme ns, String agentID) {
		super(ns, agentID);
	}
	...
	public boolean deadline(Map<String, AgentData> currentOrgKnowledge, int currentTime) {
		...
		BusyRoadNormScheme castedNS = (BusyRoadNormScheme)this.ns;
