...
public class CreateAgentTest {
	...
	public void createAgent() {
		...
		RoadNetwork rn = DataModelXML.instantiateRoadNetwork("tests/Controller/CreateAgent/", "NodeTest.xml", "EdgeTest.xml");
		ArrayList<Route> routes = DataModelXML.getRoutes(rn, "tests/Controller/CreateAgent/", "RouteTest.xml");
