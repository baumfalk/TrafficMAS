...
Random random = new Random(1337);
		...
		RoadNetwork rn = DataModelXML.instantiateRoadNetwork("tests/SimulationModelTraaS/NextSimulationState/", "NodeTest.xml", "EdgeTest.xml");
		ArrayList<Route> routes = DataModelXML.getRoutes(rn, "tests/SimulationModelTraaS/NextSimulationState/", "RouteTest.xml");
